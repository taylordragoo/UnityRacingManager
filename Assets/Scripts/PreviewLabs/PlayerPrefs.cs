...
namespace PreviewLabs
{
	public static class PlayerPrefs
	{
		...
		public static readonly string fileName = Application.persistentDataPath + "/PlayerPrefs.txt";
		...
		public static void SetEncryptedData(string inData)
		{
			PreviewLabs.PlayerPrefs.DeleteAll();
			PreviewLabs.PlayerPrefs.serializedInput = PreviewLabs.PlayerPrefs.Decrypt(inData);
			if (!string.IsNullOrEmpty(PreviewLabs.PlayerPrefs.serializedInput))
			{
				PreviewLabs.PlayerPrefs.Deserialize();
			}
		}
	}	
}